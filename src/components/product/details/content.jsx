...
const ProductDetailsContent = ({product, ...props}) => {
    let { description, variants, options, name,price} = product;
    variants = product?.getProduct|| "undefined";
    const dispatch = useDispatch();
    
    const shortDesc = excerpt(description?description:variants.description?variants.description:" ", 40);
                ...
                setSelectedOptions((prevValue) => {
                    return {
                        ...
                        [variant?.name]: {
                            ...
                            label: toCapitalize(variants?.values[0])
                        }
                    }
                })
            })
        ...
        <ContentWrap {...props}>
            ...
            <ProductPrices>
                {isDiscounted ? (
                    ...
                    <span className="price new">{"EGP " + `${price? price: variants.price}`}</span>
                )}
            </ProductPrices>
