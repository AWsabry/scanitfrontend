...
const HomepageVideo = () => {
    ...
    return (
        <div className="text-center" style={{width: "80%", margin: "auto"}}>
            ...
            <iframe className="w-100" style={{height: 700}} src={video} title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowFullScreen></iframe>
        </div>
    );
}
